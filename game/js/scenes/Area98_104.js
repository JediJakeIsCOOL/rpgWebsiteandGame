class Area98_104 extends BaseScene {
    constructor() {
        super(`Area98_104`);
    }

    preload() {
        var area = '/assets/sprites/background-images/area_98_104.png';
        super.preload(`area98_104`, area);
    }

    create() {
        var currArea = [98, 104];
        var sceneBorders = {x: [40, 480], y: [20, 480]}; // Scene dimensions
        var areaChanges = {
            northChange : [
                sceneBorders.x[0],
                sceneBorders.x[1], 
